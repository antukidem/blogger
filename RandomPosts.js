function FeaturedPostSide(a){
  (function(e){
    ...
    for(var o=0;o<s.length;o++)
    {
      ...
      l+='<li><a target="_blank" href="'+q+'"><div class="overlayx"></div><img class="random b-lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="  data-src="'+u+'"/><h4>'+k+'</h4></a><div class="label_text"><span class="date">                   </span>'+"</div></li>";
    //alert(k);
    //alert(u); 
    }
